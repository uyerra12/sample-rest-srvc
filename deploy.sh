...
KEY_PREFIXES="CF_WORKER_ADMIN_KEY1;CF_WORKER_ADMIN_KEY2;CF_WORKER_ADMIN_KEY3;CF_WORKER_ADMIN_KEY4;CF_WORKER_ADMIN_KEY5;ALGOLIA_ADMIN_API_KEY;ALGOLIA_APP_ID;CLOUDFLARE_API_KEY;HASURA_ADMIN_ENDPOINT;HASURA_ADMIN_KEY"
